System.register(['angular2/http', "rxjs/add/operator/map", "angular2/core"], function(exports_1, context_1) {
    ...
    return {
        ...
        execute: function() {
            connectorServices = (function () {
                function connectorServices(_http) {
                    this._http = _http;
                    this._url = "http://jsonplaceholder.typicode.com/posts";
                }
                connectorServices.prototype.getData = function () {
                    return this._http.get(this._url)
                        .map(function (result) { return result.json(); });
                };
                connectorServices.prototype.postData = function (data2Post) {
                    return this._http.post(this._url, JSON.stringify(data2Post))
                        .map(function (result) { return result.json(); });
                };
                connectorServices = __decorate([
                    core_1.Injectable(), 
                    __metadata('design:paramtypes', [http_1.Http])
                ], connectorServices);
                return connectorServices;
            }());
            exports_1("connectorServices", connectorServices);
        }
    }
});
